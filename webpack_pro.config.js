...
module.exports = function (env) {
  ...
  console.log('当前node环境是否是production', isProd, nodeEnv)

  const serviceWorkerBuild = env && env.sw

//   const htmlTemplate = isProd ? 'index.prod.ejs' : 'index.dev.ejs'
  const htmlTemplate = path.resolve(__dirname, 'index.template.html')
  ...
  if (isProd) {
    ...
    plugins.push(
      ...
      new webpack.DllReferencePlugin({ context: __dirname, manifest: require('./dll/main-manifest.json')})
